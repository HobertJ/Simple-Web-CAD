...
import orientation from "Main/Operations/orientation";

class Unigon extends Shape implements Renderable, Transformable {
    public type: Type.Unigon;
    ...
    public setUnigonAttributes(tx: number, ty: number, degree: number, sx: number, sy: number, kx: number, ky: number, arrayOfPoints: Point[]): void {
    ...
    //         const orientationValue = orientation(this.arrayOfPoints[i], this.arrayOfPoints[i + 1], this.arrayOfPoints[i + 2]);
    //         if (orientationValue !== 0) { // Ignore collinear points
    //             const pointsInOrder = orientationValue === 1 ? [this.arrayOfPoints[i], this.arrayOfPoints[i + 1], this.arrayOfPoints[i + 2]] : [this.arrayOfPoints[i], this.arrayOfPoints[i + 2], this.arrayOfPoints[i + 1]];
    //             reorderedPoints.push(...pointsInOrder);
    //         }
    //     }
    //     this.arrayOfPoints = reorderedPoints; // Assign the reordered points
    // }


}

export default Unigon;